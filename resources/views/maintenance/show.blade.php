    ...
    <div class="row">
        <div class="col-md-12 col-md-offset-0">
            <div class="panel panel-default">
                ...
                <div class="panel-heading col-md-10">Maintenance</div>
                ...
                <div class="panel-body col-md-10" style="background-color: white">
                    <table class="table">
                            ...
                            <tr>
                                ...
                                <a href="{{ url('create_maintenance')}}" class="btn btn-success">Add Maintenance</a>
                             </div>
                            </tr>
                                <tr>
                                    <th>Amount</th>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="edit_maintenance/{{$maintenance->id}}" class="btn btn-success">Edit</a> 
                                </td>
                            </tr>

    ...
    <div class="row">
        <div class="col-md-12 col-md-offset-0">
            <div class="panel panel-default">
                ...
                <div class="panel-heading col-md-10">New Maintenance</div>

                <div class="panel-body col-md-8">

                    <form class="form-horizontal" method="POST" action="{{url('/store_maintenance') }}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('revision_date') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="revision_date" type="date" class="form-control" name="revision_date" value="{{ old('revision_date') }}" required autofocus>

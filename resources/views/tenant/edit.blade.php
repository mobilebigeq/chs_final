    ...
    <div class="row">
        <div class="col-md-12 col-md-offset-0">
            <div class="panel panel-default">
                ...
                <div class="panel-heading col-md-10">Edit Tenant</div>

                <div class="panel-body col-md-8">

                    <form class="form-horizontal" method="POST" action="{{url('/update_tenant',array($tenants->id)) }}" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('full_name') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="full_name" type="text" class="form-control" name="full_name" value="{{ $tenants->full_name }}" required autofocus>
                         ...
                         <div class="form-group{{ $errors->has('permanent_address') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <textarea id="permanent_address" type="text" class="form-control" name="permanent_address" value="{{ old('permanent_address') }}" required autofocus>{{$tenants->permanent_address}}</textarea>
                        ...
                        <div class="form-group{{ $errors->has('agreement_copy') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-4">
                                <img src="{{ $tenants->agreement_copy }}" class="avatar">
                                <input id="agreement_copy" type="file" class="form-control" name="agreement_copy" value="{{ $tenants->agreement_copy }}">
                        ...
                        <div class="form-group{{ $errors->has('police_verification') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-4">
                                <img src="{{ $tenants->police_verification }}" class="avatar">
                                <input id="police_verification" type="file" class="form-control" name="police_verification" value="{{ $tenants->police_verification }}">
                        ...
                        <div class="form-group{{ $errors->has('address_proof1') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-4">
                                <img src="{{ $tenants->address_proof1 }}" class="avatar">
                                <input id="address_proof1" type="file" class="form-control" name="address_proof1" value="{{ $tenants->address_proof1 }}">
                        ...
                        <div class="form-group{{ $errors->has('address_proof2') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-4">
                                <img src="{{ $tenants->address_proof2 }}" class="avatar">
                                <input id="address_proof2" type="file" class="form-control" name="address_proof2" value="{{ $tenants->address_proof2 }}">
                         ...
                         <div class="form-group{{ $errors->has('email_address') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="email_address" type="text" class="form-control" name="email_address" value="{{ $tenants->email_address }}">
                        ...
                        <div class="form-group{{ $errors->has('mobile_number') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="mobile_number" type="text" class="form-control" name="mobile_number" value="{{ $tenants->mobile_number }}" required autofocus>

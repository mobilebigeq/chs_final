    ...
    <div class="row">
        <div class="col-md-12 col-md-offset-0">
            <div class="panel panel-default">
                ...
                <div class="panel-heading col-md-10">New Society Board Member</div>

                <div class="panel-body col-md-8">

                    <form class="form-horizontal" method="POST" action="{{url('/store_societyboardmember') }}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('from_date') ? ' has-error' : '' }}">
                         ...
                         <div class="form-group{{ $errors->has('to_date') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="to_date" type="date" class="form-control" name="to_date" value="{{ old('to_date') }}" required autofocus>

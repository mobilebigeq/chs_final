    ...
    <div class="row">
        <div class="col-md-12 col-md-offset-0">
            <div class="panel panel-default">
                ...
                <div class="panel-heading col-md-10">New Payment</div>

                <div class="panel-body col-md-8">

                    <form class="form-horizontal" method="POST" action="{{url('/store_payment') }}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('payment_date') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="payment_date" type="date" class="form-control" name="payment_date" value="{{ old('payment_date') }}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('pg_status') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="pg_status" type="text" class="form-control" name="pg_status" value="{{ old('pg_status') }}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('pg_response') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="pg_response" type="text" class="form-control" name="pg_response" value="{{ old('pg_response') }}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('payment_status') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="payment_status" type="text" class="form-control" name="payment_status" value="{{ old('payment_status') }}" required autofocus>
